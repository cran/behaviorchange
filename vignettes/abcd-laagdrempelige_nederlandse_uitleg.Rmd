...
Zo'n specificatie kan worden geopend in de speciale module "behaviorchange - Tools for Behavior Change Researchers and Professionals", die in het evenees gratis programma "jamovi" kan worden geinstalleerd (zie https://www.jamovi.org). In dit programma kan de ABCD matrix worden bewerkt en kan de ABCD zelf worden geproduceerd en opgeslagen als PDF. 
